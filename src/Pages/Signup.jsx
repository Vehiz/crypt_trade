...
const Signup = () => {
  ...
  return (
<section className="relative w-full h-screen bg-blue-600 bg-[url('src/assets/jiggy-home-hero-gradient.jpeg')] bg-cover bg-center flex flex-col items-center justify-center mt-[x]">
      ...
      <div className="flex flex-col md:flex-row w-full lg:w-3/5 bg-transparent from-blue-600 via-blue-700 to-blue-900 bg-opacity-80 rounded-md items-center gap-5 justify-center p-8">
        {/* <div className="text-center text-white md:w-1/2 md:text-left">
          <p className="leading-tight text-2xl w-full">
            Hello there, <br />
            We are pleased to welcome you onboard. BitMine wishes you a happy
            trading experience.
          </p>
        </div> */}
        <form
      ...
      <div className="text-gray-400 mt-11">
        <p>Copyright © {new Date().getFullYear()} BitMine</p>
      </div>
    </section>
  );
};
